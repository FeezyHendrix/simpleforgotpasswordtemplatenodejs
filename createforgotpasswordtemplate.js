function createtemplate (name, link, companyname, currentyear) {
    return `
        ...
        <style type="text/css" rel="stylesheet" media="all">
          ...
          *:not(br):not(tr):not(html) {
          ...
          body {
            ...
            margin: 0;
            line-height: 1.4;
            background-color: rgb(36, 85, 234);
            color: #74787e;
          ...
          .button--blue {
            ...
            border-top: 10px solid #3271e5;
            border-right: 18px solid #3271e5;
            border-bottom: 10px solid #3271e5;
            border-left: 18px solid #3271e5;
          }
                      ...
                      <tr>
                        <td class="content-cell">
                          ...
                          <p>
                            ...
                            ${companyname} account. Use the button below to reset it.
                            <strong
